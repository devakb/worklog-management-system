...
@section('content')
    <div class="main py-4">
        <div class="card card-body border-0 shadow">
            <h2 class="mb-4 h5">{{ __('User Create') }}</h2>
            ...
            <form action="{{ route('users.store') }}" method="POST">
                ...
                <div class="row mb-4 gy-2 flex-column">
                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        <input type="text" name="name" value="{{ old("name") }}" class="form-control @error('name') is-invalid @enderror" required placeholder="eg. Jonh Due">
                        @error('name')
                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        <input type="email" name="email" value="{{ old("email") }}" class="form-control @error('email') is-invalid @enderror" required placeholder="eg. example@project.com">
                        @error('email')
                            <div class="invalid-feedback"><i class="fa fa-info-circle me-1"></i>{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        <input type="password" name="password" value="{{ old("password") }}" class="form-control @error('password') is-invalid @enderror" required placeholder="xxxxxxxx">
                        @error('password')
                            <div class="invalid-feedback"><i class="fa fa-info-circle me-1"></i>{{ $message }}</div>
                        @enderror
                    </div>
