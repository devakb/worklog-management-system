                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input readonly value="{{ auth()->user()->designation }}" class="form-control bg-white">
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input readonly value="{{ auth()->user()->is_active ? "Active" : "Inactive" }}" class="form-control bg-white">
                                </div>
                            </div>
